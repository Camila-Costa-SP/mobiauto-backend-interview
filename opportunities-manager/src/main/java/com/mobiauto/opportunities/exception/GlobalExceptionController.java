...
public class GlobalExceptionController {
    ...
    @ExceptionHandler({
            ...
            ProductInterestNotFoundException.class,
            OpportunityNotFoundException.class})
        public ResponseEntity<CustomErrorResponse> handleNotFoundException(RuntimeException ex, HttpServletRequest request) {
